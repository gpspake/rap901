...
import {getReleaseArtists, ReleaseArtistsLink} from "../../components/ReleaseArtistsLink.tsx";

export const Route = createFileRoute('/_layout/releases/$releaseId')({
  component: ReleaseComponent,
})

function getReleaseQueryOptions({releaseId}: { releaseId: string }) {
  return {
    queryFn: () =>
      ReleasesService.readRelease({id: releaseId}),
...
function ReleaseComponent() {
  ...
  const {
    ...
    ...getReleaseQueryOptions({releaseId}),
              ...
              <div className="mx-auto max-w-2xl lg:max-w-5xl">
                <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
                  <div className="lg:pl-20">
                    <div className="max-w-xs px-2.5 lg:max-w-none z-20">
                      {frontImage && <img
                        alt=""
                        loading="lazy"
                        width="800"
                        ...
                        decoding="async"
                        data-nimg="1"
                        className="-rotate-3 rounded bg-zinc-100 object-cover dark:bg-zinc-800"
                        style={{color: "transparent"}}
                        sizes="(min-width: 1024px) 32rem, 20rem"
                        src={`https://imagedelivery.net/br00h4PfwSBLLXuS3E5D-g/${frontImage.cloudflare_id}/lg`}
                      />}
                    </div>
                    <div className="max-w-xs px-2.5 lg:max-w-none z-10">
                      {backImage && <img
                        alt=""
                        loading="lazy"
                        width="800"
                  ...
                  <div className="lg:order-first lg:row-span-2">
                    ...
                    <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
                      <p>I’ve loved making
                        things for as long as I can remember, and wrote my first program when I was 6 years old, just
                        two
                        weeks after my mom brought home the brand new Macintosh LC 550 that I taught myself to type
                        on.</p>
                      ...
                      <div className="mt-6 border-t border-white/10">
                        <dl className="divide-y divide-white/10">
                          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            <dd
                              className="mt-1 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0">{release.discogs_title}</dd>
                          </div>
                          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            <dt className="text-sm font-medium leading-6 text-white">Application for</dt>
                            <dd className="mt-1 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0">Backend
                              Developer
                            </dd>
                          </div>
                          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            <dd
                              className="mt-1 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0">margotfoster@example.com
                            </dd>
                          </div>
                          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                          ...
                          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            <dd className="mt-1 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0">Fugiat ipsum
                              ipsum deserunt
                              ...
                              <ul role="list" className="divide-y divide-white/10 rounded-md border border-white/20">
                                <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                  ...
                                  <div className="ml-4 flex-shrink-0">
                                    <a href="#"
                                       className="font-medium text-indigo-400 hover:text-indigo-300">Download</a>
                                  </div>
                                </li>
                                <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                  <div className="flex w-0 flex-1 items-center">
                  ...
                  <div className="lg:pl-20">
                    <ul role="list">
                      <li className="flex"><a
                        ...
                        <span className="ml-4">Follow on X</span></a></li>
                      ...
                      <li className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex"><a
                        ...
                        <span className="ml-4">spencer@planetaria.tech</span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
