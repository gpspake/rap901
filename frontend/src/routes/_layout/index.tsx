      ...
      <RootLayout>
        ...
        <div className="mt-16 sm:mt-20">
          <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
            <div className="relative aspect-[300/263] w-44 flex-none overflow-hidden sm:w-72 sm:rounded-sm bg-zinc-800 rotate-2">
              <img
                src={
            ...
            <div className="relative aspect-[300/263] w-44 flex-none overflow-hidden rounded-sm sm:w-72 sm:rounded-sm bg-zinc-800 -rotate-2">
              <img
                src={
