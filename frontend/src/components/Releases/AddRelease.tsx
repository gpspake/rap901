...
const AddRelease = ({ isOpen, onClose }: AddReleaseProps) => {
  ...
  const mutation = useMutation({
    mutationFn: (data: ReleaseCreate) =>
      ReleasesService.createRelease({ requestBody: data }),
    onSuccess: () => {
  ...
  const onSubmit: SubmitHandler<ReleaseCreate> = (data) => {
