      ...
      {releases.map((release) => {
        ...
        return (
          <li key={release.id}>
            ...
            <div className="group aspect-h-1 aspect-w-[1.14] block w-full rounded focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 focus-within:ring-offset-gray-100">
